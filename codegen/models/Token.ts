...
export interface Token {
     ...
     * @memberof Token
     */
    refreshExpiresMinutes?: number | null;
}
...
export function instanceOfToken(value: object): value is Token {
    ...
    if (!('expiresMinutes' in value) || value['expiresMinutes'] === undefined) return false;
    return true;
}
...
export function TokenFromJSONTyped(json: any, ignoreDiscriminator: boolean): Token {
    ...
    return {
        ...
        'expiresMinutes': json['expires_minutes'],
        'refreshExpiresMinutes': json['refresh_expires_minutes'] == null ? undefined : json['refresh_expires_minutes'],
    };
}
...
export function TokenToJSONTyped(value?: Token | null, ignoreDiscriminator: boolean = false): any {
    ...
    return {
        ...
        'expires_minutes': value['expiresMinutes'],
        'refresh_expires_minutes': value['refreshExpiresMinutes'],
    };
}
